package com.bahrin.uts_muhammadbachrinanwarharahap;
...
//Membuat File Baru Beserta Modifiernya
        preferences = peekAvailableContext().getSharedPreferences("Belajar_Shared Preferences", Context.MODE_PRIVATE);
